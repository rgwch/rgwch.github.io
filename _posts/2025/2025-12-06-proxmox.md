...
Danach können Sie von einem anderen Computer aus mit `xfreerdp3 /v:adresse /u:IhrUserName /p:IhrPassword +dynamic-resolution` auf diesen virtuellen debian 13-Computer  mit xfce Desktop zugreifen.
