...
>>> Kannst du mir bitte eine TypeScript Funktion schreiben, die eine Datei einliest, dort nach einer bestimmten regexp sucht, und für jede gefundene stelle eine zu übergebende Funktion ausreift, und
...  dann die Fundstelle gegen den Rückgabewert dieser Funktion austauscht?
```typescript
