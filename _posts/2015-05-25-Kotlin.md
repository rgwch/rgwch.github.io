...
Oder dass man gewillt ist, eine NPE in Kauf zu nehmen:

    val len=name!!.length()
    
Damit wird eine ganze Klasse von Fehlern, der beste Feind des Java-Programmierers, die NullPointerException sehr viel seltener werden.
